...
import { Resource } from '@kaiseratlas/parser';
import { ParserService } from '../../parser';
import { ElasticsearchService } from '@nestjs/elasticsearch';

@Injectable()
export class ResourcesService extends ProductEntitiesService<Resource>(
  Resource,
) {
  constructor(
  ...
  protected readonly index = 'resources';
  ...
  protected async transform(resource: Resource): Promise<any> {
